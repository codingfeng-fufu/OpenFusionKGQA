...
class GLMClient:
    ...
    def _mock_chat_completion(
        ...
        if "报告" in user_message and ("title" in user_message or "findings" in user_message):
            ...
            ("实体" in user_message and "entity_types" in user_message.lower())
            or "extract entities" in user_message.lower()
            or '"entities"' in user_message.lower()
        ):
            # 实体提取 mock
        ...
        return json.dumps(
            {
                "entities": [
                    ...
                    },
                    {
                        ...
                        "type": "Technology",
                        "description": "A graph structure used as evidence.",
                        "confidence": 0.86,
                    },
                    {
                        "name": "Neo4j",
                        "type": "Database",
                        "description": "A graph database used for graph storage.",
                        "confidence": 0.85,
                    },
                ],
                "relationships": [
                    ...
                    },
                    {
                        ...
                        "target": "Knowledge Graph",
                        "relation": "stores",
                        "description": "Neo4j stores knowledge graph data.",
                        "confidence": 0.78,
                    },
                ],
            },
